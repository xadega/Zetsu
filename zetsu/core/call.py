...
from zetsu import LOGGER, YouTube, app
from zetsu.misc import db
from zetsu.utils.database import (add_active_chat,
                                       ...
                                       set_loop)
from zetsu.utils.exceptions import AssistantErr
from zetsu.utils.inline.play import (stream_markup,
                                          telegram_markup)
from zetsu.utils.stream.autoclear import auto_clean
from zetsu.utils.thumbnails import gen_thumb
...
class Call(PyTgCalls):
    ...
    async def join_call(
        ...
        try:
            ...
            raise AssistantErr(
                "**Assisten Sudah di Obrolan Suara**\n\nSistem telah mendeteksi bahwa assisten sudah ada di obrolan suara, masalah ini biasanya muncul saat Anda memainkan 2 kueri bersamaan.\n\nJika assisten tidak ada dalam obrolan suara, harap akhiri obrolan suara dan mulai obrolan suara baru lagi dan jika masalah ini berlanjut, coba /restart"
            )
