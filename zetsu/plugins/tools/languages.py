...
from zetsu.utils.database import get_lang, set_lang
from zetsu.utils.decorators import (ActualAdminCB, language,
                                         languageCB)
...
@app.on_message(filters.command(LANGUAGE_COMMAND, [".", "(", "-", "!", "/"])
    & filters.group
    & ~filters.edited
    & ~BANNED_USERS
)
