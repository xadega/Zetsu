...
from zetsu.utils.database import (add_nonadmin_chat,
...
from zetsu.utils.decorators.admins import ActualAdminCB
from zetsu.utils.decorators.language import language, languageCB
from zetsu.utils.inline.settings import (
    audio_quality_markup, auth_users_markup,
    cleanmode_settings_markup, playmode_users_markup, setting_markup,
    video_quality_markup)
from zetsu.utils.inline.start import private_panel

### Command
SETTINGS_COMMAND = get_command("SETTINGS_COMMAND")


@app.on_message(filters.command(SETTINGS_COMMAND, [".", "^", "-", "!", "/"])
    & filters.group
    & ~filters.edited
    & ~BANNED_USERS
)
