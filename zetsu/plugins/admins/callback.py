...
from zetsu.misc import SUDOERS, db
from zetsu.utils.database import (is_active_chat,
...
from zetsu.utils.formatters import seconds_to_min
from zetsu.utils.inline.play import (panel_markup_1,
                                          panel_markup_2,
                                          panel_markup_3,
                                          stream_markup,
                                          telegram_markup)
    ...
    if command == "Pause":
        ...
        if int(command) in [1, 3]:
            if (duration_played - duration_to_skip) <= 10:
                ...
                return await CallbackQuery.answer(
                    f"Bot tidak dapat mencari karena durasi telah terlampaui.\n\nDimainkan **{bet}** Menit Dari **{duration}** Menit",
                    show_alert=True,
                )
