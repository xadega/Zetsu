...
from zetsu.utils.database import add_sudo, remove_sudo
...
async def useradd(client, message: Message, _):
    if MONGO_DB_URI is None:
        return await message.reply_text(
            "**Karena masalah privasi bot, Anda tidak dapat mengelola pengguna sudo saat Anda menggunakan Database Zetsu.**"
        )
