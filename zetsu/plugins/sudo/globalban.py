...
from zetsu.utils import get_readable_time
from zetsu.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
...
@app.on_message(filters.command("mgbanlist", [".", "^", "-", "!", "/"]) & SUDOERS)
@language
async def gbanned_list(client, message: Message, _):
    ...
    msg = "☠️ **Daftar Pengguna GBanning:**\n\n"
    count = 0
