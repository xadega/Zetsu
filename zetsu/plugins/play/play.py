...
from zetsu import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from zetsu.core.call import zetsu
from zetsu.utils import seconds_to_min, time_to_seconds
from zetsu.utils.channelplay import get_channeplayCB
from zetsu.utils.database import is_video_allowed
from zetsu.utils.decorators.language import languageCB
from zetsu.utils.decorators.play import PlayWrapper
from zetsu.utils.formatters import formats
from zetsu.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from zetsu.utils.inline.playlist import botplaylist_markup
from zetsu.utils.logger import play_logs
from zetsu.utils.stream.stream import stream
    ...
    async def wrapper(_, message: Message):
        ...
        try:
            try:
                ...
                try:
                    await message.reply(
                        f"👋🏻 ʜᴀʟʟᴏ {rpk}. **ᴀɢᴀʀ ʙɪsᴀ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ʙᴏᴛ ᴀɴᴅᴀ ʜᴀʀᴜs ᴊᴏɪɴ ᴋᴇ ᴄʜᴀɴɴᴇʟ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ!. sɪʟᴀʜᴋᴀɴ ᴋʟɪᴋ ᴛᴏᴍʙᴏʟ ᴅɪ ʙᴀᴡᴀʜ ᴜɴᴛᴜᴋ ᴊᴏɪɴ ᴋᴇ ᴄʜᴀɴɴᴇʟ. ꜱᴇᴛᴇʟᴀʜ ɪᴛᴜ ꜱɪʟᴀʜᴋᴀɴ ᴘʟᴀʏ ᴍᴜꜱɪᴋ/ᴠɪᴅᴇᴏ ᴋᴀᴍᴜ!**",
