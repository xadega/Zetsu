...
- You can change images which are used in Zetsu.
- You can generate telegaph links from [Zetsu](http://t.me/zetsuXrobot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [Zetsu String](http://t.me/ZetsuStringBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [Zetsu String](http://t.me/ZetsuStringBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [Zetsu String](http://t.me/ZetsuStringBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [Zetsu String](http://t.me/ZetsuStringBot) in Telegram.
